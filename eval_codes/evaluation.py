...
def eval_from_image(gen_path, gt_path):
    ...
    is_score_gen, _ = inception_score(dataset_gen, cuda=True, batch_size=32, resize=True, splits=10)
...
if __name__=='__main__':
    ...
    eval_from_image(gen_path, gt_path)